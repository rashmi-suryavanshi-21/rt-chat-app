  ...
  return (
    <div className="min-h-screen bg-base-200 pt-24 px-4">
      <div className="max-w-3xl mx-auto space-y-8 relative">
        <button
          onClick={() => navigate(-1)}
          className="absolute -top-12 right-0 p-2 rounded-full hover:bg-base-300 transition"
        >
          <X size={24} />
        </button>
              ...
              {requests.map((req) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold">{req.senderId.fullName}</h3>
        ...
        <div className="bg-base-300 rounded-2xl p-6 shadow">
          ...
          {sentRequests.length === 0 ? (
            <p className="text-base-content/60">No sent requests</p>
          ) : (
            <div className="space-y-4">
